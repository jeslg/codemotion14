...
trait MapRepoInterpreter extends RepoInterpreter {
  ...
  var state: State = ApplicationState(Map(), Map()) 
...
trait CacheRepoInterpreter extends RepoInterpreter {
  ...
  private val WORD_NAMESPACE = "es.scalamad.dictionary.models.word"
  private val USER_NAMESPACE = "es.scalamad.dictionary.models.user"
}
